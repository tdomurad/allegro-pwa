...
export default function SortDropdown() {
  return (
    <div className="flex justify-between items-center w-full bg-gray-900 text-white px-4 py-2 rounded">
      ...
      <div className="flex items-center space-x-6">
        <div className="relative">
          ...
          <select
            className="h-8 bg-gray-900 border border-gray-600 text-sm pl-3 pr-8 rounded cursor-pointer"
      ...
      <div className="flex items-center space-x-2 text-sm">
        ...
        <input
          ...
          readOnly
          value="1"
          className="w-10 h-8 bg-gray-900 border border-gray-600 text-center rounded text-white"
        />
